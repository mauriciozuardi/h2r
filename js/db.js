...
function criaEventos(){
	...
	e.dataInicial			= "September 22, 2011 10:00:00";
	e.dataFinal				= "December 18, 2012 10:00:00";
	e.visual					= "g";
	e.onde						= "Sesc Santos";
	// e.quem						= "Cristiano Mascaro // Flávio Damm // Carlos Moreira // Orlando Azevedo // Juan Esteves // Marcelo Buainain // Tuca Vieira // Curadoria: Eder Chiodetto";
	// e.oque						= "Bressonianas // Acervo Sesc de Arte brasileira";
	// e.oqueTipo				= "Exposição";
	// e.textoHome				= "Primeira mostra da série de fotografias Bressonianas como parte do Acervo SESC de Arte Brasileira. Formada por 42 imagens de sete fotógrafos brasileiros, a exposição tem o intuito de mostrar como a estética e o conceito do Instante Decisivo, do fotógrafo francês Henri Cartier-Bresson, influenciou a fotografia brasileira tanto no fotojornalismo quanto no fotodocumentário praticado a partir dos anos 50.";
	new EventDot(e);
	
	e.dataInicial			= "January 01, 2011 10:00:00";
	e.dataFinal				= "December 18, 2012 10:00:00";
	e.visual					= "g";
	e.onde						= "Teste";
	// e.quem						= "Cristiano Mascaro // Flávio Damm // Carlos Moreira // Orlando Azevedo // Juan Esteves // Marcelo Buainain // Tuca Vieira // Curadoria: Eder Chiodetto";
